...
const Footer = () => {
  return (
    <footer className="bg-[#004755] text-white py-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 px-20 py-5">
        ...
        {/* Services Section */}
        <div className="ml-auto text-[#7da3a9]  text-[14px] font-semibold">
          <ul className="ml-auto flex flex-col gap-5">
        ...
        <div className="ml-auto text-[#7da3a9]  text-[14px] font-semibold">
          ...
          <div className="pt-44 flex gap-5 items-center justify-center">
